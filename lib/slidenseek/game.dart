...
class SlidenSeek extends StatefulWidget {
  const SlidenSeek({super.key, required this.type});
  final type;
  @override
  SlidenSeekState createState() => SlidenSeekState();
}

class SlidenSeekState extends State<SlidenSeek> {
