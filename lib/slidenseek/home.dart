...
class SlidenseekHome extends StatefulWidget {
  const SlidenseekHome({super.key});

  @override
  State<SlidenseekHome> createState() => _SlidenseekHomeState();
}

// final GlobalKey<_SnakeGameState> snakeGameKey = GlobalKey<_SnakeGameState>();
class _SlidenseekHomeState extends State<SlidenseekHome> {
  @override
  void initState() {
