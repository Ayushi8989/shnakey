...
class SnakeyLoss extends StatefulWidget {
  const SnakeyLoss({super.key, required this.points});

  final points;
  @override
  State<SnakeyLoss> createState() => _SnakeyLossState();
}

class _SnakeyLossState extends State<SnakeyLoss> {
  @override
  void initState() {
