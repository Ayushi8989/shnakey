...
class SnakeyWin extends StatefulWidget {
  const SnakeyWin({super.key, required this.points});

  final points;
  @override
  State<SnakeyWin> createState() => _SnakeyWinState();
}

class _SnakeyWinState extends State<SnakeyWin> {
  @override
  void initState() {
